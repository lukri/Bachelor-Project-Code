...
optionPanel.openGroup({title:"Mergin", checked:false});
...
optionPanel.openGroup({title:"Smoothing", checked:false});
var smoothMarkerBox = optionPanel.makeCheckbox({value:false, labelText:"smooth Markers", disabled:true});
var smoothTranslationBox = optionPanel.makeCheckbox({value:false, labelText:"smooth Translation", disabled:false});
...
var smoothRotationMatBox = optionPanel.makeCheckbox({value:false, labelText:"smooth Rot Mat", disabled:false});
var smoothRotationVecBox = optionPanel.makeCheckbox({value:false, labelText:"smooth Rot Vec", disabled:false});
var debugRotationBox = optionPanel.makeCheckbox({value:false, labelText:"debug Rotion"})
optionPanel.closeGroup();
...
if (location.hash === '#manually'){
	...
	videoGrabbing.showRotBox = optionPanel.makeCheckbox({value:false, labelText:"show rot"});
