/*global THREE,THREEx, CompatibilityTester, Renderer, OptionPannel, VirtualContainer, Stats, location*/
...
function renderingLoop(){
	...
	if( webglRenderEnabledCheckbox.checked === true ){
		...
		*/
		...
		renderer.render({windowWidth:windowWidth,windowHeight:windowHeight,binocularity:useBinocularityCheckbox.checked});	
