(function(awe) {
  ...
  function delete_light(awe_light_id){
    if (!tracking_lights[awe_light_id]) { console.warn('trying to delete light that doesnt exist', arguments); return; }
  ...
  function update_light(awe_light){
    if (!tracking_lights[awe_light.id]) { console.warn('trying to update light that doesnt exist', arguments); return; }
    var mesh = awe_light.get_mesh();
